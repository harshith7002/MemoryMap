  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.profileHeaderCard}>
        ...
        <div className={styles.headerInfo}>
          <div className={styles.nameRow}>
            ...
            <span className={styles.verifiedBadge}>✓ Preserved on MemoryMap</span>
          </div>
          ...
          <p className={styles.location}>📍 {expert.location}</p>
          ...
          <div className={styles.statsBar}>
            ...
            <div className={styles.statItem}>
              ...
              <span className={styles.statLabel}>Mastered Skills</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statVal}>{expert.yearsExperience} yrs</span>
              <span className={styles.statLabel}>Field Experience</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.sectionCard}>
        <h2 className={styles.sectionTitle}>🛠️ Mastered Skills & Expertise Areas</h2>
      ...
      {/* Career & Knowledge Evolution Timeline */}
      <div className={styles.sectionCard}>
        <div className={styles.timelineHeader}>
          <h2 className={styles.sectionTitle}>📅 Career & Knowledge Evolution Timeline</h2>
          <span className={styles.timelineSub}>Decades of milestone growth and tacit learning</span>
        </div>
      ...
      <div className={styles.sectionCard}>
        <h2 className={styles.sectionTitle}>📝 Preserved Memories by {expert.name}</h2>
